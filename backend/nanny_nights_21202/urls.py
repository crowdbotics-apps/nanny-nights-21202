"""nanny_nights_21202 URL Configuration
...
admin.site.site_header = "Nanny Nights"
admin.site.site_title = "Nanny Nights Admin Portal"
admin.site.index_title = "Nanny Nights Admin"

# swagger
api_info = openapi.Info(
    title="Nanny Nights API",
    default_version="v1",
    description="API documentation for Nanny Nights App",
)
